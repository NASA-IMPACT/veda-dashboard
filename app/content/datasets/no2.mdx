...
<Block>
  ...
  <Figure>
    <CompareImage
      leftImageSrc={new URL('/images/dataset/no2_east_coast_mar_avg.jpg', import.meta.url).href}
      leftImageAlt='NO2 over South America'
      leftImageLabel='March 2015-2019 Avg.'
      rightImageSrc={new URL('/images/dataset/no2_east_coast_mar_20.jpg', import.meta.url).href}
...
<Figure>
  <Image
  src={new URL('/images/dataset/no2-south-america.jpg', import.meta.url).href}
