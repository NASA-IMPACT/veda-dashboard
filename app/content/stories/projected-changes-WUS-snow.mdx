...
media:
  src: /images/story//projected-changes-WUS-snow/snow-projections-median.jpg
  alt: Matterhorn glacier field
  author:
    name: Justin Pflug
    url: 
pubDate: 2023-02-01T00:00
taxonomy:
  - name: Topics
    values:
      - Water Resources
...
<Block>
  ...
  **Authors:** 
  ...
  Justin Pflug, Sujay Kumar, Ben Livneh, Melissa Wrzesien, Kim Locke
...
<Block>
   <Prose>
    Average climate change signals were aggregated across 20-year periods at monthly timesteps. This was repeated for 23 different CMIP6 climate models, using two representations of future climate: 1) a “middle of the road” projection with small progressions in environmental sustainability (Shared Socioeconomic Pathway, SSP 2-4.5), and 2) a worst-case-scenario fossil-fueled future (SSP 5-8.5). This chart presents the average monthly increases in temperature and precipitation in the Washington state North Cascades mountain range.
   </Prose>
</Block>
...
<Block type='wide'>
  <Figure>
    <Image
       src={new URL("/images/story/projected-changes-WUS-snow/aggregated_climateDeltas.jpg", import.meta.url).href}
...
<Block>
   <Figure>
     <Image 
       src={new URL("/images/story/projected-changes-WUS-snow/habitat_spaghettiPlots.jpg", import.meta.url).href}
       alt="changes to thresholded habitat across elevation bands" 
      />
   </Figure>
   <Prose>
