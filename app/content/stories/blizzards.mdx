...
<ScrollytellingBlock>
  ...
  <Figure>
    <Image
      src={new URL('/images/story/blizzards/blizzard-art-conditions.gif', import.meta.url).href}
      alt='Artistic rendition of a winter storm intensifying to blizzard conditions.'
      attrAuthor = 'Jennifer Geary'
    />
    <Caption>
  ...
  <Chapter
    center={[-106,44]}
    zoom={4.8}
    datasetId='blizzard-snowfall-footprint'
  ...
  * Frequent Storm Systems: Low-pressure systems often develop east of the Rocky Mountains, intensifying as they move into the Plains, bringing heavy snowfall and high winds. 
  ...
  <Figure>
    <Image
      src={new URL('/images/story/blizzards/blizzards-climo-1959-2014.png', import.meta.url).href}
      alt='U.S. blizzard climatology, 1959-2014.'
      attrAuthor = 'Jill Coleman and Robert Schewartz'
      attrUrl = 'https://static1.squarespace.com/static/58b98f7bd1758e4cc271d365/t/5c5b279c24a69469aa5a4d44/1549477788244/Colemanandschwartz.pdf'
    />
    <Caption>
  ...
  A notable event during this historic blizzard was the infamous ‘Snow Bowl’. The Snow Bowl was the  annual edition of ‘The Game’ - the Ohio State-Michigan football game, played on November 25 in Columbus, Ohio. Under heavy snowfall and freezing winds, players and fans braved the elements as snowplows were used to clear the field mid-game. The extreme weather rendered passing nearly impossible, and Michigan was able to pull out a 9-3 win. This edition of ‘The Game’ remains one of the most memorable contests ever played in all of collegiate athletics.
   ...
   <Figure>
    <Image
      src={new URL('/images/story/blizzards/blizzards-1950-the-game.png', import.meta.url).href}
      alt="The 1950 edition of the Ohio State - Michigan rivalry football game was played during the height of the blizzard."
      attrAuthor = 'WolverineHistorian (YouTube)'
      attrUrl = 'https://youtu.be/tP1ZfZMbarI?feature=shared'
    />
    <Caption>
  ...
  <Figure>
    <Image
      src={new URL('/images/story/blizzards/Blizzard78_ShelbyCo_Shoveling.png', import.meta.url).href}
      alt="Residents of Shelby County, Ohio with shovels in hand post-blizzard."
      attrAuthor = 'Ross Historical Society'
    />
    <Caption>
  ...
  <Figure>
    <Image
      src={new URL('/images/story/blizzards/Blizzard78_I75.png', import.meta.url).href}
      alt="Stranded motorists on I-75 in western Ohio."
      attrAuthor = 'Garst Museum'
    />
    <Caption>
  ...
  Indiana and Michigan saw the highest snow totals, pushing over 30” in a large swath from Fort Wayne and South Bend northward into Grand Rapids and Traverse City. While western Ohio recorded less snow totals, ranging from 12-24 inches, this deep snow accumulation fell atop an already significant snowpack of 18-24” or more from earlier storms. With Ohio falling on the east side of the low pressure system and thus experiencing higher wind gusts, the Buckeye State took the brunt of the significant impacts from the Blizzard of ‘78.  

  <Figure>
    <Image
      src={new URL('/images/story/blizzards/Blizzard78_Drift_UnionCity_Beamsville_Rd.png', import.meta.url).href}
  ...
  <Figure>
    <Image
      src={new URL('/images/story/blizzards/Blizzard78_Sidney_Aerial.png', import.meta.url).href}
  ...
  <Figure>
    <Image
      src={new URL('/images/story/blizzards/Blizzard78_ShelbyCo_Road_Truck.png', import.meta.url).href}
  ...
  <Figure>
    <Image
      src={new URL('/images/story/blizzards/Blizzard78_BeforeAfter_House_PascoMontra.png', import.meta.url).href}
  ...
  <Figure>
    <Image
      src={new URL('/images/story/blizzards/blizzards-1991-goes.gif', import.meta.url).href}
      alt="GOES satellite imagery of the 1991 Halloween Blizzard at peak strength (NOAA)."
      attrAuthor = 'NOAA'
      attrUrl = 'https://cimss.ssec.wisc.edu/satellite-blog/archives/3719'
    />
    <Caption>
  ...
  Some of the most infamous satellite imagery was collected during this blizzard by NASA and NOAA, as it displayed a perfect example of the classic large comma-head shape of a mature mid-latitude cyclone.

  <Figure>
    <Image
      src={new URL('/images/story/blizzards/blizzards-1993-goes-Storm-of-the-Century.gif', import.meta.url).href}
      alt="GOES imagery of the progression of the Storm of the Century (NOAA)."
      attrAuthor = 'NOAA'
      attrUrl = 'https://www.nesdis.noaa.gov/news/the-storm-of-the-century-look-back-noaa-satellites'
    />
    <Caption>
  ...
  <Chapter
    ...
    zoom={5}
    datasetId='blizzard-merra2'
    layerId='blizzard-merra2-2m-temp'
    datetime='2016-01-23'
  >
  ### Historic Blizzards
  ...
  <Figure>
    <Image
      src={new URL('/images/story/blizzards/blizzards-2016-jonas-snowpack.png', import.meta.url).href}
      alt="Suomi NPP TrueColor satellite imagery of the snowfall footprint left behind by Winter Storm Jonas (NASA/NOAA)."
      attrAuthor = 'NASA/NOAA'
      attrUrl = 'https://www.vox.com/science-and-health/2016/1/25/10827358/east-coast-blizzard-space-photos-nasa'
    />
    <Caption>
    GOES-7 satellite imagery of the 1991 Halloween Blizzard in the visible and infrared channels, showing the cyclone at peak strength.
    </Caption>
...
<Block>
  ...
  <Figure>
    <Image
      src={new URL('/images/story/blizzards/Blizzard78_WestMilton_Snow.png', import.meta.url).href}
...
<Block>
  <Figure>
    <Image
      src={new URL('/images/story/blizzards/blizzards-burst-pipe.jpeg', import.meta.url).href}
      alt="Burst pipe in Texas during the 2021 freeze causes damage to a home."
      attrAuthor = 'Thomas Black'
      attrUrl = 'https://www.usatoday.com/story/news/nation/2021/02/17/ice-hangs-off-ceiling-fan-texas-one-many-surreal-winter-photos/6781681002/'
    />
    <Caption>
