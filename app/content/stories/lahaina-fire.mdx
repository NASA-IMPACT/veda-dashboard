...
media:
  src: /images/story//lahaina-fire/lahaina-fire-background.jpg
...
<Block>
  <Figure>
    <Image
      src={new URL('/images/story/lahaina-fire/lahaina-fire-drought-monitor.jpg', import.meta.url).href}
...
<Block>
  <Prose>
    ...
    **Editors**: Andrew Blackford, Trent Cowan, Derek Koehl, Jerika Chung, Brian Freitag, and Udaysankar Nair
