...
media:
  src: /images/story//camp-fire-burn-scar/camp-fire-background.jpg
  alt: Engulfed hillside in California, 2021.
  author:
    name: Mike Newbry
    url: https://unsplash.com/photos/DwtX9mMHBJ0
pubDate: 2023-12-08T00:00
taxonomy:
  - name: Topics
    values:
      - Natural Disasters
...
<Block>
  ...
  <Figure>
      <Image
      src={new URL('/images/story/camp-fire-burn-scar/camp-fire-sentinel-20181111.jpg', import.meta.url).href}
...
<Block>
  ...
  <Figure>
      <Image
      src={new URL('/images/story/camp-fire-burn-scar/camp-fire-sentinel-20181111-falsecolor.jpg', import.meta.url).href}
      alt='Camp Fire on November 11, 2018'
    />
    <Caption>
...
<Block>
  <Figure>
     <video style={{ width: '100%', aspectRatio: "16/9" }} controls>
      <source
        src={new URL('/images/story/camp-fire-burn-scar/camp-fire-perimeter-progression.mp4', import.meta.url).href} type="video/mp4"
      />
...
<Block>
  <Figure>
    <Chart
      dataPath={new URL('/charts/story/camp-fire-burn-scar/camp-fire-ndvi.csv', import.meta.url).href}
      dateFormat="%m/%d/%Y"
      xKey='Date'
      yKey='NDVI'
      yAxisLabel='NDVI'
...
<Block>
  <Figure>
    <Chart
      dataPath={new URL('/charts/story/camp-fire-burn-scar/camp-fire-albedo.csv', import.meta.url).href}
      dateFormat="%m/%d/%Y"
      idKey='Sources'
      xKey='Date'
      yKey='Albedo'
...
<Block>
  <Figure>
    <Chart
      dataPath={new URL('/charts/story/camp-fire-burn-scar/camp-fire-lst-celsius.csv', import.meta.url).href}
      dateFormat="%m/%d/%Y"
      idKey='Sources'
      xKey='Date'
      yKey='LST'
...
<Block>
  ...
  <Figure>
    <video style={{ width: '100%', aspectRatio: "16/9" }} controls>
      <source
        src={new URL('/images/story/camp-fire-burn-scar/camp-fire-oroville-location.mp4', import.meta.url).href} type="video/mp4"
      />
      Your browser does not support the video tag.
    </video>
...
<Block>
  <Figure>
    <Chart
      dataPath={new URL('/charts/story/camp-fire-burn-scar/camp-fire-oroville-ndti.csv', import.meta.url).href}
      dateFormat="%Y%j"
      idKey='Source'
      xKey='Date'
      yKey='NDTI'
  ...
  <Figure>
     <video style={{ width: '100%', aspectRatio: "16/9" }} controls>
      <source
        src={new URL('/images/story/camp-fire-burn-scar/camp-fire-oroville-ndti.mp4', import.meta.url).href} type="video/mp4"
      />
      Your browser does not support the video tag.
    </video>
