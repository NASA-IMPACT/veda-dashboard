...
media:
  src: /images/story//changing-landscapes/changing-landscapes--cover.jpg
...
<Block type='full'>
  <Figure>
      <Image
        src={new URL('/images/story/changing-landscapes/changes-parking-lot.png', import.meta.url).href}
...
<Block type='full'>
  ...
  <Figure>
      <Image
        src={new URL('/images/story/changing-landscapes/changes-ports.png', import.meta.url).href}
...
<Block type='full'>
  <Figure>
      <Image
        src={new URL('/images/story/changing-landscapes/changes-heat.png', import.meta.url).href}
...
<Block type='wide'>
  <Figure>
    <CompareImage 
      leftImageSrc={new URL('/images/story/changing-landscapes/changes-surf-temp-2018-04.png', import.meta.url).href}
      leftImageAlt='Satellite view of the bay area indicating surface temperature in April 2018'
      leftImageLabel='April 2018'
      rightImageSrc={new URL('/images/story/changing-landscapes/changes-surf-temp-2020-04.png', import.meta.url).href}
...
<Block type='wide'>
  <Figure>
      <Image
        src={new URL('/images/story/changing-landscapes/changes-fires.png', import.meta.url).href}
