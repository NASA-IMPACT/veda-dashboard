...
media:
  src: /images/story//houston-aod/steam-power-plant.png
...
<ScrollytellingBlock>
  ...
  >
    ...
    <Chart
      dataPath={new URL('/charts/story/houston-aod/baytown_adjusted.csv', import.meta.url).href}
      dateFormat="%Y-%m"
      idKey='source'
      xKey='Date'
      yKey='Mean AOD'
  ...
  >
    ...
    <Chart
      dataPath={new URL('/charts/story/houston-aod/west_houston_adjusted.csv', import.meta.url).href}
      dateFormat="%Y-%m"
      idKey='source'
      xKey='Date'
      yKey='Mean AOD'
  ...
  >
    ...
    <Chart
      dataPath={new URL('/charts/story/houston-aod/Houston_IAH.csv', import.meta.url).href}
      dateFormat="%Y-%m"
      idKey='source'
      xKey='Date'
      yKey='Mean AOD'
